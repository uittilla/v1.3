 ...
 */
Game_v1_3.prototype.worker = function () {
    // Baddies
 ...
 */
Game_v1_3.prototype.updatePlayer = function (player) {
 ...
 * Update bad guys
 */
Game_v1_3.prototype.updateEnemy = function (id, baddy) {
 ...
 */
Game_v1_3.prototype.shipMissileContact = function (id, missile) {
    var particle = {};
 ...
 */
Game_v1_3.prototype.missileContact = function (id, missile) {
 ...
 */
Game_v1_3.prototype.enemyMissileContact = function (missile) {
    var player;
    for (var p in this.players) {
 ...
 * circle to circle
 */
Game_v1_3.prototype.checkCollision = function (baddyA, i) {
    for (var j in this.enemies) {
        if (j != i) {
 ...
 */
Game_v1_3.prototype.shipContact = function (player) {
 ...
 */
Game_v1_3.prototype.unixTime = function () {
 ...
 */
Game_v1_3.prototype.bad_guys = function (num) {
    var baddy;
    for (var i = 0; i < num; i++) {
        baddy = new Enemy();
 ...
 */
Game_v1_3.prototype.boss = function () {
    return {
        id: 'boss',
        x: this.width / 2,
        y: this.height / 2,
...
Game_v1_3.prototype.getPlayer = function (p) {
    return this.players[p];
}

Game_v1_3.prototype.getPlayers = function () {
    return this.players;
}

Game_v1_3.prototype.setPlayers = function (players) {
    this.players = players;
}

Game_v1_3.prototype.getEnemies = function () {
    return this.enemies;
}

Game_v1_3.prototype.setEnemies = function (enemies) {
