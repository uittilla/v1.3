...
class Player {
    ...
    rotate (radianAngle) {
        let centre = new Vector2D(this.position.x, this.position.y);
        centre.add(this.B);
        centre.add(this.C);
    ...
    resolveCollision (object) {
        let n = this.position.subtractNew(object.position);
        ...
        // a1 = v1 . n
        // a2 = v2 . n
        let a1 = this.velocity.dot(n);
        let a2 = object.velocity.dot(n);
        //console.log("pass2");
        // Using the optimized version,
        // optimizedP =  2(a1 - a2)
        //              -----------
        //                m1 + m2
        let optimizedP = (2.0 * (a1 - a2)) / (this.mass + object.mass);

        // Calculate v1', the new movement vector of circle1
        // v1' = v1 - optimizedP * m2 * n
        //let v1' = v1 - optimizedP * circle2.mass * n;

        let nv_a = this.velocity.subtractNew(n.scalarMultiplyNew(optimizedP * object.mass));

        // Calculate v1', the new movement vector of circle1
        // v2' = v2 + optimizedP * m1 * n
        //Vector v2' = v2 + optimizedP * circle1.mass * n;
        let nv_b = object.velocity.addNew(n.scalarMultiplyNew(optimizedP * this.mass));
